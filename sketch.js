...
let b1 = new Button("Resetear (R)",55,600-35,65,20,new Color(0,0,0));
let b2 = new Button("Iniciar",1000-92,600-75,65,20,new Color(0,0,0));
let b3 = new Button("Aleatorio (W)",55,600-60,65,20,new Color(0,0,0));
let b4 = new Button("Manual (M)",1000-105,600-25,65,20,new Color(0,0,0));
